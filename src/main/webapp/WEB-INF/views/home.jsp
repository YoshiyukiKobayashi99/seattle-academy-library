    ...
    <main>
        ...
        <div class="function">
            <div>
             ...
             <div>
                <form method="post" action="isbnSerch">
                <input type="search" class=search1 name="isbnSerch" placeholder="ISBNで登録できます">
                    <button type="submit" class="btn_search" name="submit">簡易追加</button>
                </form>
            </div>
            <div>
